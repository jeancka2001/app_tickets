...
/* Mapa de asientos "en vivo" de una localidad (tipo fila/mesa), tal como lo
   consulta la web (Modallocalida.js -> localidaandespacio). Reemplaza al
   endpoint viejo "mikroti/Boleteria/localidades/{id}/todo" que la app usaba
   antes: ese devolvía asientos que ya habían sido borrados en la base de
   datos, porque es una fuente de datos distinta/desactualizada — este es
   el mismo que usa la web y sí refleja los borrados. */
